...
def printUsage():
    ...
    print("    +10 - <ngram version> has no memory errors AND");
    print("    +40 - <ngram version> completes in less than 1 second OR");
    print("    +30 - <ngram version> completes in less than 2 seconds OR");
    print("    +20 - <ngram version> completes in less than 30 seconds OR");
    print("     +0 - <ngram version> completes in >= 30 seconds");
    sys.exit(0);
